...
Я начинающий разработчик на С++<img src="https://media.giphy.com/media/WUlplcMpOCEmTGBtBW/giphy.gif" width="30px">. Учусь программировать в течении 3-х лет. Вначале попробовал создать сайт, потом второй... Понравилось).
